...
if [ "$TARGET_NODE" == "default" ]; then
    ...
    export MONOSCENE_OUTPUT='/root/dev0/implementation/shared_evtOcc/MonoScene/results'
    ...
    export NYU_PREPROCESS='--' # not used.
    export NYU_ROOT='--' # not used.
    export NYU_LOG='--' # not used.

    export KITTI_PREPROCESS='/root/local1/changwoo/preprocess_cw'
    export KITTI_PREPROCESS_LOW='/root/dev/data/dataset/SemanticKITTI/preprocess_cw_lowResolution' # for low resolution
    export KITTI_ROOT='/root/dev/data/dataset/SemanticKITTI'
    export KITTI_LOG='/root/storage/implementation/shared_evtOcc/MonoScene_depth_v2/kitti_log'

    export MONOSCENE_OUTPUT='/root/storage/implementation/shared_evtOcc/MonoScene_depth_v2/result' 
    ...
    export KITTI_PREPROCESS_LOW='/root/data0/dataset/SemanticKITTI/preprocess_cw_lowResolution' # for low resolution
    export KITTI_ROOT='/root/data0/dataset/SemanticKITTI'
    export KITTI_LOG='/root/dev0/implementation/shared_evtOcc/MonoScene_depth_v2/kitti_log'
    export KITTI_EVT_ROOT='/root/data0/dataset/SemanticKITTI/event_bin3_onoff'

    export MONOSCENE_OUTPUT='/root/dev0/implementation/shared_evtOcc/MonoScene_depth_v2/results'
    ...
    export MONOSCENE_OUTPUT='/root/dev0/implementation/shared_evtOcc/MonoScene_depth_v2/result'
